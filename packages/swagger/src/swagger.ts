...
export interface SwaggerUIConfigOptions {
   ...
   */
  modelPropertyMacro?: ((propName: Readonly<unknown>) => unknown) | undefined;
  /**
   ...
   */
  parameterMacro?:
    | ((operation: Readonly<unknown>, parameter: Readonly<unknown>) => unknown)
    | undefined;
 ...
 */
type SwaggerUIPlugin = (system: unknown) => {
  statePlugins?:
    | Record<
        string,
        {
  ...
  afterLoad?: ((system: unknown) => unknown) | undefined;
